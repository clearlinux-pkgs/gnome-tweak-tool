...
Version  : 3.26.0
Release  : 7
URL      : https://download.gnome.org/sources/gnome-tweak-tool/3.26/gnome-tweak-tool-3.26.0.tar.xz
Source0  : https://download.gnome.org/sources/gnome-tweak-tool/3.26/gnome-tweak-tool-3.26.0.tar.xz
...
%prep
%setup -q -n gnome-tweak-tool-3.26.0
...
export LANG=C
export SOURCE_DATE_EPOCH=1505320949
