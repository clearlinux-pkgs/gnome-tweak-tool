...
Source0  : https://download.gnome.org/sources/gnome-tweak-tool/3.26/gnome-tweak-tool-3.26.1.tar.xz
...
%prep
%setup -q -n gnome-tweak-tool-3.26.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1505941908
