...
Source0  : https://download.gnome.org/sources/gnome-tweak-tool/3.26/gnome-tweak-tool-3.26.3.tar.xz
...
%prep
%setup -q -n gnome-tweak-tool-3.26.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1509423743
